...
const ScrollableTabBar = React.createClass({
  ...
  getDefaultProps() {
    return {
      scrollOffset: 52,
      activeTextColor: Colors.headline,
      inactiveTextColor: Colors.headline,
  ...
  renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
    ...
    >
      <View style={[styles.tab, this.props.tabStyle, ]}>
        <Text style={[{fontFamily: 'Avenir', fontSize: scaleByVertical(30), color: textColor, fontWeight, }, textStyle ]}>
          {name}
        </Text>
      </View>
    </Button>;
